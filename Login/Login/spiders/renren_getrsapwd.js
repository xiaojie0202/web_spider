...
function GetRSAPwd(pwd, public_key) {
    l(2 * 19);
    var T = new t("10001", "null", public_key);
    encrypted = n(T, pwd);
    return encrypted;
}

function GetDate() {
    var haha_data = new Date;
    return "&uniqueTimestamp=" + haha_data.getFullYear() + haha_data.getMonth() + haha_data.getDay() + haha_data.getHours() + haha_data.getSeconds() + haha_data.getUTCMilliseconds();
